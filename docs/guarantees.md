...
release gate, so a failing one blocks the release.

| Backend | Atomic publication | Trigger atomicity | Stale-owner recovery | Ordering | Durability |
| --- | --- | --- | --- | --- | --- |
| sqlite | guaranteed | guaranteed | guaranteed | guaranteed | guaranteed |
| postgres | guaranteed | guaranteed | guaranteed | guaranteed | guaranteed |
| redis | best effort | best effort | best effort | guaranteed | best effort |
| mongodb | not supported | best effort | best effort | guaranteed | best effort |
| mongodb3 | not supported | best effort | best effort | guaranteed | best effort |
| rabbitmq | not supported | n/a | n/a | guaranteed | best effort |
| memory | not supported | guaranteed | n/a | guaranteed | not supported |
