...
(function () {
  ...
  function attach() {
    ...
    var svgs = document.querySelectorAll(
      "article .mermaid svg:not(.pynenc-lightbox-ready), article div[class*='mermaid'] svg:not(.pynenc-lightbox-ready)",
    );
    svgs.forEach(function (svg) {
      svg.classList.add("pynenc-lightbox-ready");
      ...
      svg.addEventListener("click", function (e) {
        ...
        open(dataUri, "State machine diagram");
      });
    });
  }
